  ...
  return (
    <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100 flex flex-col h-full">
      ...
      <div className="p-4 flex flex-col flex-grow">
        ...
        <div className="mt-auto pt-4 border-t border-gray-200 flex justify-between items-center gap-3 flex-nowrap">
          ...
          <Link href={projectId ? `/funds/fundraising/${projectId}` : "#"}>
            <button
              className={`px-6 py-2.5 font-semibold text-white rounded-lg cursor-pointer transition-transform hover:scale-105 bg-green-600 hover:bg-green-700 whitespace-nowrap flex-shrink-0`}
            >
              Đầu tư ngay
            </button>
          </Link>
  ...
  return (
    <div className="h-full">
      ...
      >
        ...
        <div className="mt-auto pt-2 flex items-end justify-between gap-3 flex-nowrap">
          <h4 className="font-bold text-gray-800 line-clamp-1 mr-1 min-w-0">
            {project.name}
          </h4>
          <Link href={project.id ? `/funds/fundraising/${project.id}` : "#"}>
            <button className="px-2 py-2 text-sm font-semibold text-white rounded-lg bg-green-600 hover:bg-green-700 transition-colors whitespace-nowrap flex-shrink-0">
              Đầu tư ngay
            </button>
          </Link>
        </div>
