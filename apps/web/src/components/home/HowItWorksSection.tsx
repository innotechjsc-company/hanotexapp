...
const steps = [
  {
    ...
    description:
      "Tạo tài khoản miễn phí với thông tin cá nhân hoặc doanh nghiệp",
  ...
  },
  {
    ...
    description:
      "Tải lên thông tin chi tiết về công nghệ, sản phẩm hoặc dịch vụ của bạn",
  ...
  },
  {
    ...
    description:
      "Tìm kiếm và khám phá các công nghệ phù hợp với nhu cầu của bạn",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Quy trình đơn giản và minh bạch để tham gia sàn giao dịch công nghệ
            HANOTEX
          </p>
        </div>
            ...
            <div key={step.title} className="relative">
              ...
              <div className="bg-white rounded-xl shadow-lg border border-gray-200 h-full">
                <div className="px-6 py-4 text-center">
                  {/* Icon */}
                  <div
                    className={`inline-flex items-center justify-center w-16 h-16 rounded-full ${step.bgColor} ${step.color} mb-4`}
                  >
        ...
        <div className="text-center mt-16">
          <div className="bg-white rounded-2xl shadow-lg p-8 max-w-2xl mx-auto">
            ...
            <p className="text-gray-600 mb-6">
              Tham gia ngay hôm nay để trở thành một phần của cộng đồng công
              nghệ Hà Nội
            </p>
