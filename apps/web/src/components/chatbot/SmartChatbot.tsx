...
export default function SmartChatbot({
  ...
  const recognizeIntent = (message: string): string => {
    ...
    if (
      lowerMessage.includes("định giá") ||
      lowerMessage.includes("thẩm định")
    ) {
      return "valuation";
    }
  ...
  const handleQuickAction = (action: QuickAction) => {
    ...
    setTimeout(async () => {
      ...
      const response = await getResponseForIntent(
        intent,
      ...
      fields: [
        {
          ...
          label: "Tên công nghệ",
          required: true,
          placeholder: "VD: Hệ thống AI xử lý ảnh y tế",
        },
        {
          name: "field",
          type: "select",
        ...
        },
        {
          ...
          required: true,
          placeholder: "Mô tả ngắn gọn về công nghệ...",
        },
        {
          name: "main_features",
          type: "textarea",
        ...
        },
        {
          ...
          required: true,
          placeholder: "Các ứng dụng cụ thể...",
        },
        {
          name: "advantages",
          type: "textarea",
          ...
          required: true,
          placeholder: "Điểm mạnh so với giải pháp hiện tại...",
        },
        {
          name: "patent_status",
          type: "text",
          label: "Trạng thái bằng sáng chế",
          required: false,
          placeholder: "Đã cấp/Đang xét duyệt/Chưa có",
        },
        {
          name: "certifications",
          type: "text",
        ...
        {
          name: "protection_territory",
          type: "text",
          label: "Lãnh thổ bảo hộ",
          required: false,
          placeholder: "Việt Nam, PCT...",
        },
        {
          name: "contact_info",
          type: "textarea",
                ...
                steps={[
                  {
                    ...
                    description:
                      "Thu thập và chuẩn bị các thông tin cơ bản về công nghệ",
                    status: "pending",
                    ...
                    tips: [
                      "Sử dụng từ khóa rõ ràng, dễ hiểu",
                  ...
                  },
                  {
                    ...
                    description:
                      "Đánh giá và xác định Technology Readiness Level của công nghệ",
                    status: "pending",
                    estimatedTime: "10-20 phút",
                    requirements: [
                      "Hiểu biết về TRL 1-9",
                  ...
                  },
                  {
                    ...
                    description:
                      "Tập hợp các tài liệu kỹ thuật, chứng nhận và bằng sáng chế",
                    status: "pending",
                    ...
                    tips: [
                      "Scan tài liệu với độ phân giải cao",
                      "Định dạng PDF để dễ đọc",
                    ],
                  },
                  {
                    id: "step4",
                    ...
                    description:
                      "Khai báo đầy đủ thông tin về quyền sở hữu trí tuệ",
                    status: "pending",
                    estimatedTime: "15-30 phút",
                    requirements: [
                      "Bằng sáng chế",
                    ...
                    tips: [
                      "Kiểm tra tính hợp lệ của bằng sáng chế",
                  ...
                  },
                  {
                    ...
                    description:
                      "Lựa chọn hình thức chuyển giao công nghệ phù hợp",
                    status: "pending",
                    estimatedTime: "10-20 phút",
                    requirements: [
                      "Mục tiêu thương mại",
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-60 p-4">
          <div className="bg-white rounded-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6">
              ...
              <TemplateGenerator
                templates={technologyTemplates as any}
