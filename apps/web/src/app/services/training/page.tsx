      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Nâng cao năng lực và kỹ năng thông qua các chương trình đào tạo
            chuyên nghiệp về công nghệ và sở hữu trí tuệ
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow">
            ...
            <p className="text-gray-600 mb-4">
              Các khóa học về công nghệ mới, xu hướng phát triển và ứng dụng
              thực tế
            </p>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-3">
              Đào tạo Sở hữu trí tuệ
            </h3>
            <p className="text-gray-600 mb-4">
              Chương trình đào tạo chuyên sâu về quản lý và bảo vệ tài sản trí
              tuệ
            </p>
            <ul className="text-sm text-gray-500 space-y-1">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Học tập linh hoạt qua nền tảng online với video bài giảng chất
                lượng cao
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Tham gia các khóa học tại trung tâm với sự hướng dẫn trực tiếp
                từ chuyên gia
              </p>
            </div>
            <div className="text-center">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-xl p-8 text-center text-white">
          ...
          <p className="text-xl mb-6 opacity-90">
            Tham gia các khóa đào tạo chuyên nghiệp và phát triển sự nghiệp của
            bạn
          </p>
