...
import { ProjectNegotiationDetailsScreen } from "@/screens/project-negotiation-details-screen";
...
export default function NegotiationDetailsPage() {
  ...
  return <ProjectNegotiationDetailsScreen projectProposeId={proposalId} />;
}
