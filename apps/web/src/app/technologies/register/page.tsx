...
export default function RegisterTechnologyPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    // Pháp lý & Lãnh thổ
    legalTerritory: {
      protectionTerritories: [] as string[],
      certifications: [] as string[],
      localCertificationFiles: [] as Array<{
        id: number;
        name: string;
        size: number;
        type: string;
    ...
    investmentTransfer: {
      investmentStage: "",
      commercializationMethods: [] as string[],
      transferMethods: [] as string[],
      territoryScope: "",
      financialMethods: [] as string[],
      usageLimitations: "",
      currentPartners: "",
      potentialPartners: "",
    },
    ...
    setFormData((prev) => ({
      ...
      legalTerritory: {
        ...
        protectionTerritories: checked
          ...
          : prev.legalTerritory.protectionTerritories.filter(
              (t) => t !== territory
            ),
      },
    }));
    ...
    setFormData((prev) => ({
      ...
      legalTerritory: {
        ...
        certifications: checked
          ...
          : prev.legalTerritory.certifications.filter(
              (c) => c !== certification
            ),
      },
    }));
  ...
  const handleLocalCertificationUpload = async (
  ...
  const removeLocalCertificationFile = (index: number) => {
    setFormData((prev) => ({
      ...
      legalTerritory: {
        ...prev.legalTerritory,
        localCertificationFiles:
          prev.legalTerritory.localCertificationFiles.filter(
            (_, i) => i !== index
          ),
      },
    }));
  ...
  const processOCR = async (file: File) => {
    ...
    try {
      ...
      if (result.success && result.extractedData) {
        ...
        setSuccess(
          `OCR đã xử lý thành công! Đã tự động điền thông tin từ tài liệu.`
        );
      }
    } catch (error) {
          ...
          <div className="bg-white shadow rounded-lg">
            ...
            <div className="p-6 space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                {formData.submitter.submitterType ===
                ...
                >
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        updateOwner(index, "ownerType", e.target.value)
                      }
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                    >
                      <option value="INDIVIDUAL">Cá nhân</option>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        value={ip.ipNumber}
                        onChange={(e) =>
                          updateIPDetail(index, "ipNumber", e.target.value)
                        }
                        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                    ...
                    <div>
                      ...
                      <select
                        value={ip.status}
                        onChange={(e) =>
                          updateIPDetail(index, "status", e.target.value)
                        }
                        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                        disabled={masterDataLoading}
                      >
            ...
            <div className="p-6 space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div>
                  ...
                  <div className="space-y-2 max-h-48 overflow-y-auto border border-gray-300 rounded-lg p-3">
                    {masterData?.protectionTerritories.map((territory) => (
                      ...
                      >
                        <input
                          type="checkbox"
                          checked={formData.legalTerritory.protectionTerritories.includes(
                            territory.value
                          )}
                          onChange={(e) =>
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    *PCT là đơn quốc tế (chưa là bằng); EPO/USPTO/JPO là cơ quan
                    cấp bằng/đơn tương ứng.
                  </p>
                </div>
                  ...
                  <div className="space-y-2 max-h-48 overflow-y-auto border border-gray-300 rounded-lg p-3">
                    {masterData?.certifications.map((certification) => (
                      ...
                      >
                        <input
                          type="checkbox"
                          checked={formData.legalTerritory.certifications.includes(
                            certification.value
                          )}
                          onChange={(e) =>
                ...
                <div>
                  ...
                  <div
                    ...
                    onClick={() =>
                      document.getElementById("local-cert-upload")?.click()
                    }
                  >
                  ...
                  {formData.legalTerritory.localCertificationFiles.length >
                    0 && (
                    <div className="mt-3 space-y-2">
                      {formData.legalTerritory.localCertificationFiles.map(
                        (file, index) => (
                          <div
                            key={index}
                            className="flex items-center justify-between p-2 bg-gray-50 rounded-lg"
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center">
                  ...
                  <div
                    className={`transform transition-transform ${expandedSections.investmentTransfer ? "rotate-180" : ""}`}
                  >
                    <svg
            ...
            {expandedSections.investmentTransfer && (
              <div className="p-6 space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label
                      htmlFor="investmentTransfer.investmentStage"
                      className="block text-sm font-medium text-gray-700 mb-1"
                    >
                  ...
                  <div>
                    <label
                      htmlFor="investmentTransfer.territoryScope"
                      className="block text-sm font-medium text-gray-700 mb-1"
                    >
                      Phạm vi lãnh thổ
                    </label>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                    {masterData?.commercializationMethods.map((method) => (
                      ...
                      >
                        <input
                          type="checkbox"
                          checked={formData.investmentTransfer.commercializationMethods.includes(
                            method.value
                          )}
                          onChange={(e) => {
                            const methods =
                              formData.investmentTransfer
                            ...
                            if (e.target.checked) {
                              ...
                              setFormData((prev) => ({
                                ...
                                investmentTransfer: {
                                  ...prev.investmentTransfer,
                                  commercializationMethods: methods.filter(
                                    (m) => m !== method.value
                                  ),
                                },
                              }));
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                    {masterData?.transferMethods.map((method) => (
                      ...
                      >
                        <input
                          type="checkbox"
                          checked={formData.investmentTransfer.transferMethods.includes(
                            method.value
                          )}
                          onChange={(e) => {
                            const methods =
                              formData.investmentTransfer.transferMethods;
                            if (e.target.checked) {
                              setFormData((prev) => ({
                                ...prev,
                                investmentTransfer: {
                              ...
                              setFormData((prev) => ({
                                ...
                                investmentTransfer: {
                                  ...prev.investmentTransfer,
                                  transferMethods: methods.filter(
                                    (m) => m !== method.value
                                  ),
                                },
                              }));
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label
                      htmlFor="investmentTransfer.currentPartners"
                      className="block text-sm font-medium text-gray-700 mb-1"
                    >
                  ...
                  <div>
                    <label
                      htmlFor="investmentTransfer.potentialPartners"
                      className="block text-sm font-medium text-gray-700 mb-1"
                    >
                      Đối tác tiềm năng
                    </label>
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center">
                  ...
                  <div
                    className={`transform transition-transform ${expandedSections.pricing ? "rotate-180" : ""}`}
                  >
                    <svg
                      className="w-5 h-5 text-gray-500"
                      fill="none"
                  ...
                  {formData.pricing.pricingType === "APPRAISAL" && (
                    <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                          <label
                            htmlFor="pricing.appraisalPurpose"
                            className="block text-sm font-medium text-gray-700 mb-1"
                          >
                            Mục đích thẩm định
                          </label>
                        ...
                        <div>
                          <label
                            htmlFor="pricing.appraisalDeadline"
                            className="block text-sm font-medium text-gray-700 mb-1"
                          >
                            Thời hạn mong muốn
                          </label>
                        ...
                        <div className="md:col-span-2">
                          <label
                            htmlFor="pricing.appraisalScope"
                            className="block text-sm font-medium text-gray-700 mb-1"
                          >
                            Phạm vi thẩm định
                          </label>
                          ...
                          >
                            ...
                            <option value="IP_TECHNOLOGY">
                              IP + công nghệ + tài sản kèm
                            </option>
                            <option value="FULL_PROJECT">Toàn bộ dự án</option>
                          </select>
                          <p className="text-xs text-gray-500 mt-1">
                            Hệ thống sẽ tạo <strong>valuation_request</strong>{" "}
                            tới bên thẩm định được phê duyệt.
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  {formData.pricing.pricingType === "AUCTION" && (
                    <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                          <label
                            htmlFor="pricing.auctionStartDate"
                            className="block text-sm font-medium text-gray-700 mb-1"
                          >
                            Thời gian bắt đầu
                          </label>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                        <p className="text-sm text-yellow-800">
                          Bạn không đặt giá – người mua sẽ gửi đề nghị. Có thể
                          bật "gợi ý khoảng giá" dựa trên dữ liệu thị trường.
                        </p>
                      </div>
                    </div>
                  )}
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center">
                  ...
                  <div
                    className={`transform transition-transform ${expandedSections.visibilityNDA ? "rotate-180" : ""}`}
                  >
                    <svg
                      className="w-5 h-5 text-gray-500"
                      fill="none"
              ...
              <div className="p-6 space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <div className="space-y-2">
                      {[
                        ...
                        {
                          field: "publicSummary",
                          label: "Mô tả ngắn (2-3 câu)",
                        },
                        {
                          field: "classification",
                          label: "Lĩnh vực/Ngành/Chuyên ngành",
                        },
                        { field: "trlLevel", label: "TRL" },
                        { field: "owners", label: "Chủ sở hữu" },
                        {
                          field: "ipDetails",
                          label: "Loại chứng nhận (không hiển thị số)",
                        },
                      ].map((item) => (
                    ...
                    <p className="text-xs text-gray-500 mt-2">
                      Không công khai: số bằng, tài liệu chi tiết, dữ liệu tài
                      chính.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      {[
                        {
                          field: "confidentialDetail",
                          label: "Mô tả chi tiết kỹ thuật",
                        },
                        {
                          field: "documents",
                          label: "Tài liệu minh chứng (PDF/Ảnh/Video)",
                        },
                        { field: "ipNumbers", label: "Số đơn/Số bằng" },
                        {
                          field: "financials",
                          label: "Dữ liệu tài chính/kiểm thử chi tiết",
                        },
                        {
                          field: "contacts",
                          label: "Liên hệ trực tiếp nhóm R&D",
                        },
                      ].map((item) => (
                        <label key={item.field} className="flex items-center">
                          <input
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  <h4 className="text-sm font-medium text-blue-900 mb-2">
                    🔍 Xem trước phần CÔNG KHAI:
                  </h4>
                  <div className="text-sm text-blue-700">
                    Tên, mô tả ngắn, taxonomy, TRL, ứng dụng (theo lựa chọn
                    trường công khai).
                  </div>
                </div>
              </div>
