...
# HANOTEX AUTO DEPLOYMENT SCRIPT
# Tự động setup server Ubuntu cho HANOTEX

set -e

echo "🚀 Starting HANOTEX Server Setup..."
...
echo
read -s -p "Enter Payload secret: " PAYLOAD_SECRET
echo
...
NEXT_PUBLIC_PAYLOAD_API_URL=https://$DOMAIN/admin/api
...
log "🎉 HANOTEX deployment completed successfully!"
log "🌐 Website: https://$DOMAIN"
log "🎛️ Admin: https://$DOMAIN/admin"
...
info "4. Test your website: https://$DOMAIN"
